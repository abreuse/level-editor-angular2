...
var sprite_1 = require("../pojo/sprite");
...
var MenuComponent = (function () {
    ...
    MenuComponent.prototype.addSprite = function (name) {
        this.sprites.push(new sprite_1.Sprite(name, name.charAt(0), "app/sprites/" + this.random(1, 9) + ".png"));
        console.log(JSON.stringify(this.sprites));
    };
    MenuComponent.prototype.random = function (min, max) {
